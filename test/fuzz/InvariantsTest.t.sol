...
contract Invariants is StdInvariant, Test {
    ...
    function invariant_totalSupplyLessThanCollateral() public view {
        ...
        console.log("wbtcValue: %s", totalBtcDeposited);
        console.log("totalSupply: %s", totalSupply);
        console.log("Times dsc minted: %s", handler.timesMintIsCalled());
    ...
    function invariant_getterViewFunctions() public view {
        ...
        dscEngine.getCollateralBalanceOfUser(address(this), address(dsc));
        dscEngine.getCollateralBalanceOfUser(address(this), address(dscEngine));
        dscEngine.getCollateralBalanceOfUser(address(this), address(0));
    }
}
